...
This privacy policy applies to the Sweet Home Business app for mobile devices, together with any related services operated by Shadyar Bzhar Othman (collectively, the "Application"). Shadyar Bzhar Othman is hereby referred to as the "Service Provider".
